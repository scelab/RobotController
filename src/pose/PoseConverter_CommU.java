...
public class PoseConverter_CommU implements PoseConverter {

	private final double REDUCTION_RATIO_BODY_P   = 3.833;
	private final double REDUCTION_RATIO_L_SHOU_P = 1.364;
	private final double REDUCTION_RATIO_R_SHOU_P = 1.364;
	private final double REDUCTION_RATIO_HEAD_R   = 4.333;
